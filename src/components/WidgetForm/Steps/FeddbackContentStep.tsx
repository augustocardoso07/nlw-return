    ...
    <>
      <header>
        <button
          ...
          onClick={() => {
            console.log("ei");
            props.onFeedbackTypeChanged(null);
          }}
        >
      ...
      <form className="my-4 w-full" onSubmit={handleSubmitFeedback}>
        <textarea
          className="min-w-[384px] w-full min-h-[112px] placeholder-zinc-480 text-zinc-100 border-zinc-600 bg-transparent rounded-md focus:border-brand-500 focus:ring-brand-500 focus:outline-none focus:ring-1 resize-none scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
          placeholder="Conte com detalhes o que est[a acontecendo"
